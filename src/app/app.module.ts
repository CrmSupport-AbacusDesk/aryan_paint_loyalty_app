...
import { KarigarListPageModule } from '../pages/karigar-list/karigar-list.module';
import { KarigaraddPageModule } from '../pages/karigaradd/karigaradd.module';
import { KarigardetailPageModule } from '../pages/karigardetail/karigardetail.module';
import { SalesPointListPageModule } from '../pages/sales-point-list/sales-point-list.module';
...
@NgModule({
    ...
    imports: [
        ...
        KarigarListPageModule,
        KarigaraddPageModule,
        KarigardetailPageModule,
