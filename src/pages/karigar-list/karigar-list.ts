...
export class KarigarListPage {
  ...
  getKarigarList(status, search)
  {
    ...
    this.dbService.post_rqst( {'filter':this.filter,'sales_employee_id' : this.dbService.karigar_id,'user_type':'1'}, 'app_karigar/sales_user_painter').subscribe(response =>
      {
    ...
    loadData(infiniteScroll)
    {
      ...
      this.dbService.post_rqst({'filter' : this.filter  ,'sales_employee_id' : this.dbService.karigar_id,'user_type':'1'},'app_karigar/sales_user_painter').subscribe( r =>
        {
