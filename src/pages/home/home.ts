...
import { SalesPointListPage } from '../sales-point-list/sales-point-list';
@Component({
    selector: 'page-home',
...
export class HomePage {
    ...
    goOnSalesPointListPage() {
        this.navCtrl.push(SalesPointListPage);
    }
    ...
    viewKarigarList() {
        this.navCtrl.push(KarigarListPage);
    }
    gotoChangeLang() {
    ...
    share() {
        let image = "";
        let app_url = "https://play.google.com/store/apps/details?id=com.aryanpaints.app";
        this.socialSharing.share("Hey there join me (" + this.karigar_detail.full_name + "-" + this.karigar_detail.mobile_no + ") on ARYAN PAINTS app. Enter my code *" + this.karigar_detail.referral_code + "* to earn points back in your wallet!", "", image, app_url)
            .then(resp => {
