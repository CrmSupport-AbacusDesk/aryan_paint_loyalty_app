...
import { IonicPage, NavController, NavParams, Loading, ActionSheetController, AlertController, LoadingController } from 'ionic-angular';
...
filter:any={};
  constructor(public navCtrl: NavController, public navParams: NavParams,
    private loadingCtrl:LoadingController,public alertCtrl:AlertController,public actionSheetController: ActionSheetController,public translate:TranslateService,private camera: Camera,public service:DbserviceProvider,public con:ConstantProvider) {
  ...
  getKarigarDetail()
  {
    this.presentLoading();
      console.log('karigar');
      this.filter.painter_id = this.karigar_id;
      this.service.post_rqst( {'filter': this.filter },'app_karigar/sales_user_painter_details')
      .subscribe((r) =>
      {
          console.log(r);
          this.karigar_detail=r.karigars;
